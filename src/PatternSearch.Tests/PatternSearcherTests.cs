...
namespace PatternSearch.Tests
{
  ...
  public class PatternSearcherTests<T> where T : IPatternSearcher, new()
  {
    ...
    private readonly IPatternSearcher _searcher = new T();
    ...
    [TestCase("co się stało", "co się stało")]
    [TestCase("co się stało", "t co się stało")]
    [TestCase("co się stało", "co się stało z")]
    [TestCase("co się stało", "i co się stało z")]
